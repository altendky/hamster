...
from hamster.mcp._core.events import Done, FormatHassResponse, HassCommand
from hamster.mcp._core.groups import SourceGroup
from hamster.mcp._core.hass_group import (
    CommandInfo,
    HassGroup,
    discover_commands,
...
class TestCommandFiltering:
    ...
    def test_subscribe_prefix_filtered(self) -> None:
        ...
        from hamster.mcp._core.hass_group import _is_filtered_command
