...
from hamster.mcp._core.events import Done, FormatSupervisorResponse, SupervisorCall
from hamster.mcp._core.groups import SourceGroup
from hamster.mcp._core.supervisor_group import (
...
class TestSupervisorCallResultType:
    ...
    def test_success_result(self) -> None:
        ...
        from hamster.mcp._core.types import SupervisorCallResult
...
class TestContinuationUnion:
    ...
    def test_format_supervisor_response_in_continuation(self) -> None:
        ...
        from hamster.mcp._core.events import Continuation
